...
} from "@/components/evaluation/Labs";
...
export default function EvaluationPage() {
  ...
  const LAB_TABS: { id: LabTab; label: string }[] = [
    ...
    { id: "distancias", label: t("evaluation.distanceLabTab") },
  ...
  if (view === "simple") {
    return (
      <div className="flex flex-col gap-6 pb-6">
        {ragHeader}
        <SimpleRetrievalEval hideTitle onOpenLab={() => setView("lab")} />
      </div>
    );
  }
