...
export default function CultivosPage() {
        ...
        const dataOficial = [
          {
            ...
            descripcion:
              "Fruto caracterizado por sus pequeñas manchas oscuras en la piel ('pecas'), sabor dulce intenso y alto contenido en potasio.",
          ...
          },
          {
            ...
            descripcion:
              "Cultivado bajo condiciones climáticas subtropicales únicas, reconocido internacionalmente por su firmeza y sabor equilibrado.",
          ...
          },
          {
            ...
            descripcion:
              "Variedades históricas introducidas desde América (como la Bonita y la Negra Yema de Huevo), de textura firme y sabor almendrado.",
          ...
          },
          {
            ...
            descripcion:
              "Cepas prefiloxéricas cultivadas en suelos volcánicos únicos, destacando el famoso Malvasía Volcánica de Lanzarote.",
  ...
  const filteredCultivos = cultivosCanarias.filter((cultivo) => {
    ...
    const matchesCategoria =
      selectedCategoria === "Todos" || cultivo.categoria === selectedCategoria;
    ...
    <div className="p-8 space-y-8 bg-slate-50/50 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-2xl border border-blue-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-blue-950 mt-1">
            Cultivos Tradicionales de Canarias
          </h1>
          <p className="text-sm text-slate-600">
            Gestión, trazabilidad y cumplimiento de denominaciones de origen
            protegidas.
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-2 overflow-x-auto w-full sm:w-auto pb-2 sm:pb-0">
          {["Todos", "Fruta", "Hortaliza", "Tubérculo", "Viticultura"].map(
            (cat) => (
              <button
                key={cat}
      ...
      {loading ? (
        <div className="py-24 flex flex-col items-center justify-center bg-white rounded-2xl border border-slate-100 shadow-sm">
          ...
          <p className="text-xs font-bold text-slate-500">
            Cargando registros de cultivos...
          </p>
        </div>
      ) : error ? (
              ...
              >
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-black text-blue-950 mt-0.5 group-hover:text-[#0038A8] transition-colors">
                      {cultivo.nombre}
                    </h3>
