...
url: https://www.mapa.gob.es/es/pac/pac-2023-2027/seguimiento-y-evaluacion
category: PAC
---
...
Reglamento de ejecución sobre evaluación de los planes estratégicos de la PAC y al suministro de información para el seguimiento y la evaluación
...
El Plan de evaluación de España, finalizado el 31 de julio de 2023 y dictaminado por el Comité de seguimiento, tiene un alcance nacional y un enfoque estratégico. Este plan se ha modificado para adaptarlo a la evolución de los trabajos de evaluación. Su contenido sigue siendo de carácter general, de manera que se define en más detalle las actividades de evaluación en un plan de trabajo plurianual. El Plan de evaluación modificado ha sido consensuado con el Grupo Directivo de Evaluación y dictaminado por el Comité de seguimiento el 22 de mayo de 2026.
Plan de evaluación del PEPAC
Dictamen del Comité de seguimiento al Plan de evaluación del PEPAC y anexos
...
Evaluación de la práctica 4 de los Ecorregímenes: Siembra directa (2025) 
 
Análisis de la evolución de la competitividad, productividad y sostenibilidad del sector agrario (2024)
 
Evaluaciones sumativas:
Evaluación de la contribución del PEPAC al OT
Evaluación nacional (2025)
 
Estudios de apoyo a la evaluación realizados:
Estudio de apoyo a la evaluación del Plan Estratégico de la PAC 2023-2027: La Red Natura 2000 (2024)
 
Análisis del funcionamiento de los derechos de Ayuda Básica a la Renta realizado por el FEGA (2025)
 
...
 
 
Además, cabe destacar que, al margen de las evaluaciones que realicen los Estados miembro, la Comisión realizará evaluaciones intermedias y posteriores a escala de la Unión con la información que le faciliten los Estados miembro.
En el siguiente enlace puede encontrar documentación de interés relativa a la evaluación del PEPAC, como las evaluaciones y análisis realizados hasta el momento, materiales de los eventos formativos que organiza el MAPA, directrices del Servicio europeo de ayuda para la evaluación de la PAC y normativa. Este apartado se irá actualizando con más documentación que se tiene prevista (materiales divulgativos del MAPA, informes de evaluación, etc.)
Evaluaciones, materiales divulgativos de evaluación y documentación oficial
