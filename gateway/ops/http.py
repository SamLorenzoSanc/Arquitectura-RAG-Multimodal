...
from ops.postgres import OpsRepository
from services.database import get_db
from services.inference_warmup import warmup_ollama
...
@health_router.post("/warmup")
async def trigger_warmup():
    """Fuerza un warm-up de embedding + generación (inferencia automática)."""
    return await warmup_ollama(force=True)
...
schema_router = APIRouter(prefix="/database", tags=["Database"])
