...
url: https://www.fega.gob.es/es/ayudas-directas-y-desarrollo-rural/consulta-derechos-pago-unico
category: PAC
---

Presentación y propósito
Ha accedido Vd. a la página de la CONSULTA DE DERECHOS DE PAGO ÚNICO del FONDO ESPAÑOL DE GARANTÍA AGRARIA O.A. (FEGA).
...
|---|---|
| Consultar los derechos de pago único de un productor. Deberá introducir su CIF/NIF y el código de alguno de sus derechos. | Consulta de derechos |
Atención a usuarios
