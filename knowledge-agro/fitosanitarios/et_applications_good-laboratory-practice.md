...
url: https://www.efsa.europa.eu/et/applications/good-laboratory-practice
...
GLP principles
Good Laboratory Practice (GLP) principles refers to a set of quality and validity standards for the organisation and management of test facilities and the data they produce. GLPGood laboratory practice (GLP) is a standardised way of planning, performing and reporting laboratory-based studies to ensure a high standard of quality and reliability guides the conduct and reporting of non-clinical studies supporting food and feed chain applications that EFSA evaluates.
...
EFSA accepts GLP studies that are performed in GLP compliant test facilities located in an OECD member country or in a non-member country that adhere to the Mutual Acceptance of Data (MAD) system.
